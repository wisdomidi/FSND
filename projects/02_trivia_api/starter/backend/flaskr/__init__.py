...
def create_app(test_config=None):
    ...
    def get_questions():
        ...
        # get all categories and add them to dict
        categories = Category.query.all()
        categories_dict = {}
        for category in categories:
            categories_dict[category.id] = category.type
    ...
    # request endpoint for adding new questions and seraching 
    ...
    # request endpoint for getting questions based on category
    ...
    # request endpoint for playing the trivia game
...
# error handlers to handle errors and return well formatted json error
